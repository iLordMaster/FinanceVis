class AccountController {
  ...
  async getAll(req, res) {
    try {
      const { accounts, totalBalance } = await this.getAccounts.execute(req.user.id);
      res.json({
  ...
  async update(req, res) {
    try {
      const result = await this.updateAccount.execute(req.params.id, req.user.id, req.body);
      res.json({
