class UserController {
  constructor(getUserProfile, updateUserProfile, uploadProfilePicture) {
  ...
  async updateProfile(req, res) {
    try {
      ...
      const result = await this.updateUserProfile.execute(req.params.id, req.body);
      res.json({
  ...
  async uploadPicture(req, res) {
    try {
      ...
      const result = await this.uploadProfilePicture.execute(req.params.id, req.file.path);
      res.json({
