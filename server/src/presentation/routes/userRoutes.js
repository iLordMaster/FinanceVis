...
const DeleteProfilePicture = require("../../application/use_cases/user/DeleteProfilePicture");
...
const deleteProfilePicture = new DeleteProfilePicture(userRepository);
...
router.delete("/:id/profile-picture", authMiddleware, (req, res) =>
  userController.deletePicture(req, res)
);
